...
public class HttpUploadServerHandler1 extends SimpleChannelInboundHandler<HttpObject> {

    private static final Logger logger = Logger.getLogger(HttpUploadServerHandler1.class.getName());
    ...
    public void channelRead0(ChannelHandlerContext ctx, HttpObject msg) throws Exception {
        if (msg instanceof HttpRequest) {
            ...
            if (!uri.getPath().startsWith("/upload")) {
                // Write Menu
                //writeMenu(ctx);
                responseContent.append("{code:-1,message:'请求错误'}");
            ...
            if (request.method().equals(HttpMethod.GET)) {
                ...
                // So stop here
                responseContent.append("{code:-2,message:'不支持get方法'}");
